...
<h4 align="center"><u>Suite Bookings</u></h4> 
...
<c:forEach items="${suitedata}"  var="std"> 
<tr bgcolor="#F6B2DA"> 
...
<td>
<a href='<c:url value="setstatussuite?id=${std.id}&status=true"></c:url>'>Check-In</a>
<a href='<c:url value="setstatussuite?id=${std.id}&status=false"></c:url>'>Check-Out</a>
</td>
