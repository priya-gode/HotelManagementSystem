...
<h3 align=center style="color:green; font-size:20px">${message}</h3>
        ...
        <form action="insertsuite" method="post">
         ...
         <label for="html">
          <input type="radio" id="css" name="bed" value="CSS">
         <b>3 Bed Rooms without connection</b></label><br/><br/>
          <input type="radio" id="css" name="bed" value="CSS">
        <b>2 bed rooms with connecting hall</b></label><br><br>
         <input type="radio" id="css" name="bed" value="CSS">
        <b>3 bed rooms with connection hall</b></label><br><br>
           
