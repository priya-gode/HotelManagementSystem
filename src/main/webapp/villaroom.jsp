...
<h3 align=center style="color:green; font-size:20px">${message}</h3>
        ...
        <form action="insertvilla" method="post">
          ...
          <label class="form-label" for="departure-date">Number of Villas:</label>
         ...
         <label for="html" >
          <input type="radio" id="css" name="bed" value="CSS">
         3 BKH +swimming pool+Open Theater</label>
         <label for="html" ><br/>
         <input type="radio" id="css" name="bed" value="CSS">
         2 BKH + Barbieque+ Swimming pool</label><br/>
         <label for="html" >
         <input type="radio" id="css" name="bed" value="CSS">
         4 BKH + swimming pool+Open Theater+Barbieque</label>
           
         <label for="html">
          <input type="radio" id="css" name="bed" value="CSS">
          3 BKH +swimming pool+Home Theater+Bardieque</label><br/><br/>
           
