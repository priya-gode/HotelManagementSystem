...
<h3 align=center style="color:green; font-size:20px">${message}</h3>
        ...
        <form action="insertduplex" method="post">
          <center><h2>Enter Your Details</h2></center><br>
          <label class="form-label" for="name">Name:</label>
          <input class="form-input" type="text" id="name" name="name" required>

          <label class="form-label" for="name">Contact:</label>
          <input class="form-input" type="text" id="contact" pattern="^[6-9]\d{9}$" name="contact" required>
          ...
          <input type="number" class="form-input" id="room" name="numrooms" min="1" max="10" onchange="calculateCost()">
          <label class="form-label" for="departure-date">Number of Adults:</label>
          <input type="number" class="form-input" id="quantity" name="numadults" min="1"><br/>
          
          <label class="form-label" for="departure-date">Number of Children:</label>
          <input type="number" id="quantity" class="form-input" name="numchilds" min="0" ><br/>
         ...
         <label for="html" >
          <input type="radio" id="css" name="bed" value="CSS">
         <b>Large single bed with sofa</b></label><br><br>
         <label for="html" >
         <input type="radio" id="css" name="bed" value="CSS">
         <b>small two  beds with sofa</b></label><br/><br>
         <label for="html" >
         <input type="radio" id="css" name="bed" value="CSS">
        <b>Large single bed with one small single bed</b></label><br><br>
         <label for="html">
          <input type="radio" id="css" name="bed" value="CSS">
        <b>three small single beds</b></label><br/><br/><br>
           
  ...
  <script>
    ...
    // Set the "min" attribute of date inputs to disable past dates
    document.getElementById('arrival-date').min = currentDate;
