...
.button:active:after {
  ...
  transition: 0s;
    ...
    <body class="hero">
        ...
        <nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark ">
            <a class="navbar-brand" style="color: white;font-style:italic;font-weight:bolder;" href="#">Nivasa</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="contactadmin.jsp" style="color: white;">
  ...
  <div class="news-card">
    <a href="standardrooms" class="news-card__card-link"></a>
    <img src="https://watermark.lovepik.com/photo/20211130/large/lovepik-hotel-standard-room-picture_501283030.jpg" alt="" class="news-card__image">
    <div class="news-card__text-wrapper">
      <h2 class="news-card__title">Standered Room </h2>
      <div class="news-card__details-wrapper">
        <p class="news-card__excerpt">A standard room is one of the cheapest hotel rooms, and usually includes a double or queen bed. &hellip;</p>
        <button class="button" onclick="window.location.href = 'standardrooms'">Click Me</button>
